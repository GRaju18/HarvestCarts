sap.ui.define([
	...
	return UIComponent.extend("com.9b.harvestCarts.Component", {
		...
		init: function () {
			window.addEventListener("beforeunload", function (e) {
				e.preventDefault();
				e.returnValue = ""; // Shows the default browser "Leave site?" prompt
			});
		...
		_getDialog: function () {
			if (!this.dialog) {
				...
				this.dialog = sap.ui.xmlfragment("sessionDialog", "com.9b.harvestCarts.view.fragments.SessionTimeoutDialog", this);
			}
			return this.dialog;
		},
